  ...
  return (
    <div className="card-dark">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="ml-auto text-xs font-bold text-sunrise-300">
      ...
      <div className="space-y-2 mb-4">
          ...
          <div
            ...
            className={`flex items-center gap-3 rounded-2xl border-2 px-4 py-3 transition-all duration-200 ${
              goal.done
                ...
                : 'bg-midnight-900/40 border-midnight-600 hover:border-midnight-500'
            }`}
          >
            <button
              ...
              className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-all duration-200 active:scale-90 ${
                goal.done
                  ? 'bg-aurora-teal border-aurora-teal text-midnight-900'
                  : 'border-midnight-500 hover:border-sunrise-400'
              }`}
            ...
            <span
              className={`flex-1 text-sm font-medium ${goal.done ? 'line-through text-midnight-500' : 'text-midnight-100'}`}
            >
              {goal.text}
            </span>
            <button
        ...
        {goals.length === 0 && (
          <p className="text-sm text-midnight-400 text-center py-3">
            Ingen mål endnu – tilføj et nedenfor
          </p>
        )}
      </div>
