...
const ALL_CHALLENGES: Challenge[] = [
  ...
  {
    id: 'ch-002',
    title: 'Træk vejret dybt 5 gange',
    emoji: '🌬️',
    category: 'Ro',
    categoryIcon: '🧘',
    duration: 2,
  ...
  {
    id: 'ch-004',
    title: 'Skriv én ting du er taknemmelig for',
    emoji: '🙏',
    category: 'Refleksion',
    categoryIcon: '📓',
    duration: 3,
  ...
  {
    id: 'ch-005',
    title: 'Lyt til en sang du holder af',
    emoji: '🎵',
    category: 'Glæde',
    categoryIcon: '😊',
    duration: 4,
  ...
  {
    id: 'ch-008',
    title: 'Send en venlig besked til nogen',
    emoji: '💌',
    category: 'Social',
    categoryIcon: '👥',
    duration: 5,
    ...
    minEnergy: 2,
    completed: false,
    tags: ['social', 'forbindelse'],
  },
  {
    id: 'ch-009',
    title: 'Gå ud og få frisk luft i 5 min',
    emoji: '🌿',
    category: 'Bevægelse',
    categoryIcon: '🚶',
    duration: 5,
    ...
    minEnergy: 2,
    completed: false,
    tags: ['bevægelse', 'natur'],
  },
  {
    id: 'ch-010',
    title: 'Gå en tur på 15 minutter',
    emoji: '🚶',
    category: 'Bevægelse',
    categoryIcon: '🚶',
    duration: 15,
  ...
  {
    id: 'ch-012',
    title: 'Ring til en ven eller familie',
    emoji: '📞',
    category: 'Social',
    categoryIcon: '👥',
    duration: 15,
  ...
  },
  {
    ...
    minEnergy: 3,
    completed: false,
    tags: ['struktur', 'planlægning'],
  },
  {
    id: 'ch-014',
    title: 'Lav en kreativ aktivitet',
    emoji: '🎨',
    ...
    minEnergy: 3,
    completed: false,
    tags: ['kreativitet', 'glæde'],
  },
  {
    id: 'ch-015',
    title: 'Løb eller cykel i 20 minutter',
    emoji: '🏃',
    category: 'Bevægelse',
    categoryIcon: '🚶',
    duration: 20,
    ...
    minEnergy: 4,
    completed: false,
    tags: ['bevægelse', 'kondition'],
  },
  {
    id: 'ch-016',
    title: 'Lær noget nyt i 15 min',
    emoji: '📚',
    category: 'Læring',
    categoryIcon: '🧠',
    duration: 15,
  ...
  {
    id: 'ch-017',
    title: 'Lav en sund middag fra bunden',
    emoji: '🍳',
    category: 'Mad',
    categoryIcon: '🥗',
    duration: 30,
  ...
  {
    id: 'ch-020',
    title: 'Prøv noget du aldrig har gjort',
    emoji: '✨',
    category: 'Vækst',
    categoryIcon: '🧠',
    duration: 30,
...
const energyConfig = [
  ...
  {
    value: 3 as EnergyLevel,
    emoji: '😐',
    label: 'OK',
    color: 'text-sunrise-300',
    bg: 'bg-sunrise-400/10',
    border: 'border-sunrise-400/20',
    activeBorder: 'border-sunrise-400',
    activeBg: 'bg-sunrise-400/15',
  },
  {
    value: 4 as EnergyLevel,
    emoji: '🙂',
    label: 'God energi',
  ...
  {
    value: 5 as EnergyLevel,
    emoji: '😄',
    label: 'Fuld energi',
    color: 'text-sunrise-400',
    bg: 'bg-sunrise-500/10',
    border: 'border-sunrise-500/20',
    activeBorder: 'border-sunrise-400',
    activeBg: 'bg-sunrise-400/20',
  },
];
...
export default function DailyChallengesView() {
  ...
  const [celebration, setCelebration] = useState<{ show: boolean; challenge: Challenge | null }>({
    show: false,
    challenge: null,
  });
  ...
  return (
    <div className="min-h-screen gradient-midnight pb-28">
        ...
        <div className="max-w-lg mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 min-w-0">
              <Lys
                mood={getLysMood(energy)}
                size="sm"
                userContext={`energiniveau: ${energyLabels[energy]}`}
              />
              <CompanionAvatar
                companion={companion}
                size="sm"
              ...
              <div className="min-w-0">
                <h1 className="font-display text-base sm:text-xl font-bold text-midnight-50 truncate">
                  Udfordringer
                </h1>
                <p className="text-xs text-midnight-400 mt-0.5 truncate">
                  Tilpasset dit energiniveau
                </p>
              </div>
            </div>
            {totalXp > 0 && (
          ...
          {totalCount > 0 && (
            <div className="mt-3">
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-xs text-midnight-500 font-medium">
                  {completedCount} af {totalCount} gennemført
                </span>
                <span className="text-xs font-bold text-sunrise-400">
      ...
      <div className="max-w-lg mx-auto px-4 pt-4">
        ...
        <AiMotivationStrip
          energy={energy}
          energyLabel={energyLabels[energy]}
