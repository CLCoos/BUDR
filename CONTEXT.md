...
- **Middleware:** `middleware.ts` — park-ruter vs. `care_residents`; demo-portal bag env-flag; staff via `care_staff`; se **Sidst opdateret** ovenfor.
