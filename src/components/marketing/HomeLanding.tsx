            ...
            <div className="shell">
              ...
              <div className="pain-list" style={{ marginTop: 28 }}>
                ...
                <div className="pain-item">
                  ...
                  <div className="pain-text">
                    <strong>Dokumentation bygger på hukommelsen</strong> — ikke på det, der skete i
                    øjeblikket.
                  </div>
                </div>
                <div className="pain-item">
            ...
            <div className="shell">
              <div style={{ textAlign: 'center', maxWidth: '40rem', margin: '0 auto 40px' }}>
                ...
                <p className="intro-lead" style={{ marginTop: 14 }}>
                  ...
                  personalets arbejdsflade — overblik, varsler og journalstøtte. I BUDR hænger de to
                  sammen i realtid, så det, borgeren giver i Lys, bliver til handling og
