...
export default function LysOnboarding({
  ...
  return (
    <div
      className="fixed inset-0 z-[60] flex justify-center bg-black/45 p-4 sm:p-6"
    ...
    >
      <div className="flex h-full w-full max-w-[430px] flex-col justify-end sm:justify-center">
        <div
          className="mx-auto w-full max-w-full rounded-3xl p-6 shadow-2xl"
          style={{
