...
function AnimatedStat({ value, label }: { value: string; label: string }) {
  ...
  return (
    ...
    >
      <span className="text-3xl font-extrabold tabular-nums" style={{ color: 'var(--budr-purple)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{value}</span>
    ...
    <div className="relative mx-auto" style={{ width: 220, height: 440 }}>
      ...
      >
        ...
        <div className="flex items-center gap-2 border-b border-white/6 px-4 pb-2.5">
          <div className="flex h-7 w-7 items-center justify-center rounded-full" style={{ background: 'var(--budr-purple)' }}>
        ...
        <div className="flex flex-col gap-2 px-3 pt-3" style={{ minHeight: 260 }}>
          {/* User message */}
          <div className="chat-msg-1 self-end max-w-[70%] rounded-2xl rounded-br-sm px-3 py-2" style={{ background: 'var(--budr-purple)', opacity: 0 }}>
            <p className="text-[10px] text-white leading-snug">Jeg er lidt nervøs i dag 😟</p>
          </div>
          {/* Typing dots */}
          <div className="chat-typing self-start max-w-[50%] rounded-2xl rounded-bl-sm px-3 py-2.5" style={{ background: 'rgba(255,255,255,0.08)', opacity: 0 }}>
            <div className="flex items-center gap-1">
              <span className="typing-dot inline-block h-1.5 w-1.5 rounded-full bg-white/60" />
              <span className="typing-dot inline-block h-1.5 w-1.5 rounded-full bg-white/60" style={{ animationDelay: '0.2s' }} />
              <span className="typing-dot inline-block h-1.5 w-1.5 rounded-full bg-white/60" style={{ animationDelay: '0.4s' }} />
            </div>
          </div>
          {/* Lys response */}
          <div className="chat-msg-2 self-start max-w-[80%] rounded-2xl rounded-bl-sm px-3 py-2" style={{ background: 'rgba(255,255,255,0.08)', opacity: 0 }}>
            <p className="text-[10px] text-white/90 leading-snug">Det er helt ok at føle det sådan. Hvad tror du udløser det? 💜</p>
          </div>
          {/* Mood pill */}
          <div className="chat-msg-3 self-end opacity-0">
            <div className="flex items-center gap-1 rounded-full px-3 py-1.5 text-[9px] font-semibold" style={{ background: 'rgba(127,119,221,0.25)', color: 'var(--budr-purple)', border: '1px solid rgba(127,119,221,0.3)' }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-center gap-2 border-t border-white/6 bg-black/20 px-3 py-2.5">
          <div className="flex-1 rounded-full bg-white/8 px-3 py-1.5 text-[9px] text-white/30">Skriv til Lys…</div>
          <div className="flex h-6 w-6 items-center justify-center rounded-full" style={{ background: 'var(--budr-purple)' }}>
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex h-7 w-7 items-center justify-center rounded-xl" style={{ background: 'var(--budr-teal-light)' }}>
      ...
      <div className="flex flex-col gap-2.5">
        {residents.map((r) => (
          <div key={r.name} className="flex items-center justify-between rounded-xl px-3 py-2" style={{ background: '#f8f9fc' }}>
            <div className="flex items-center gap-2.5">
              <div
                className="h-2.5 w-2.5 rounded-full shrink-0"
                style={{ backgroundColor: statusColor[r.status], boxShadow: `0 0 6px ${statusColor[r.status]}55` }}
              />
      ...
      {/* Footer */}
      <div className="mt-4 rounded-xl px-3 py-2 text-center text-[10px] font-semibold" style={{ background: 'var(--budr-teal-light)', color: 'var(--budr-teal)' }}>
...
───────────────────────────────────────────────────────── */
const FEATURES = [
  { icon: Brain,        title: 'Recovery-orienteret',     desc: 'Bygget over KRAP og PARK-metodik',               color: '#7F77DD' },
  { icon: Clock,        title: 'Onboarding < 5 min',      desc: 'Personalet er klar inden første møde',            color: '#1D9E75' },
  { icon: Shield,       title: 'GDPR-kompatibel',         desc: 'Dansk løsning med data på dansk jord',            color: '#5E56C0' },
  { icon: Zap,          title: 'Tidlig indsats',          desc: 'Stop eskalationer, før de sker',                  color: '#F59E0B' },
  { icon: MessageSquare,title: 'Fælles sprog',            desc: 'Borger og pædagog taler ud fra samme data',       color: '#EC4899' },
  { icon: FileText,     title: '§-dokumentation',        desc: 'Struktureret output klar til indberetning',        color: '#60A5FA' },
  { icon: Heart,        title: '24/7 tilgængelig',        desc: 'Lys er der, også når personalet sover',           color: '#F472B6' },
  { icon: Star,         title: 'Mestringstro',            desc: 'XP, badges og have — fremskridt man kan se',      color: '#34D399' },
] as const;
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white font-sans text-slate-900 antialiased">
        ...
        >
          {/* Floating blobs */}
          <div className="blob pointer-events-none absolute -top-20 right-0 h-[500px] w-[500px] rounded-full opacity-[0.18] blur-3xl" style={{ background: 'var(--budr-purple)' }} />
          <div className="blob-2 pointer-events-none absolute bottom-0 -left-20 h-80 w-80 rounded-full opacity-[0.15] blur-3xl" style={{ background: 'var(--budr-teal)' }} />
          <div className="blob-3 pointer-events-none absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full opacity-[0.08] blur-3xl" style={{ background: 'var(--budr-purple-dark)' }} />
          ...
          <div className="relative mx-auto max-w-5xl">
            ...
            <div className="mb-6 flex justify-center">
              <span
                ...
                style={{ borderColor: 'rgba(127,119,221,0.3)', backgroundColor: 'rgba(127,119,221,0.08)', color: 'var(--budr-purple)' }}
              >
            ...
            <p className="mx-auto mt-6 max-w-xl text-center text-lg leading-relaxed text-slate-600 sm:text-xl">
              BUDR er Danmarks første AI-platform bygget til socialpsykiatrien.
              Borgeren har støtte i lommen. Du har overblikket.
            </p>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
              <Link
                ...
                style={{ background: 'linear-gradient(135deg, var(--budr-purple), var(--budr-purple-dark))' }}
              >
                Kom i gang gratis
            ...
            <div className="mt-16 flex flex-col items-center justify-center gap-8 sm:flex-row sm:items-start sm:gap-12">
              ...
              <div className="hidden sm:flex sm:flex-col sm:justify-center sm:gap-4 sm:pt-6">
                <CarePortalCard />
                <p className="text-center text-xs text-slate-400">Realtids-overblik for personalet</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* ── Social proof strip ───────────────────────── */}
        <section className="border-y px-5 py-12" style={{ borderColor: 'rgba(0,0,0,0.06)', background: '#fafafa' }}>
          <div className="mx-auto max-w-5xl">
            ...
            {/* Logo placeholders */}
            <div className="mb-10 flex flex-wrap items-center justify-center gap-4" data-reveal data-stagger>
              {['Botilbud Midtjylland', 'Socialpsykiatri Nordjylland', 'Pilot 2025'].map((name) => (
                <div
                  ...
                  style={{ background: '#f1f1f4', border: '1.5px solid rgba(0,0,0,0.07)', minWidth: 160 }}
                >
                  {name}
                </div>
              ))}
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div
                ...
                data-reveal
                style={{ background: 'linear-gradient(150deg, var(--budr-lavender) 0%, #ede9ff 100%)', border: '1.5px solid rgba(127,119,221,0.2)' }}
              >
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl text-2xl shadow-sm" style={{ background: 'white' }}>
                  📱
                </div>
                <h2 className="text-2xl font-extrabold text-slate-900" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  Lys — din AI-ledsager
                </h2>
                <p className="mt-2 text-sm font-semibold" style={{ color: 'var(--budr-purple)' }}>Til borgere</p>
                ...
                <ul className="mt-5 flex flex-col gap-2.5">
                  {[
                    ...
                    'Fungerer uden login — åben for alle',
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-2.5 text-sm text-slate-700">
                      <div className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full" style={{ background: 'rgba(127,119,221,0.15)' }}>
              ...
              <div
                ...
                style={{ background: 'linear-gradient(150deg, var(--budr-teal-light) 0%, #d4f5ea 100%)', border: '1.5px solid rgba(29,158,117,0.2)' }}
              >
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl text-2xl shadow-sm" style={{ background: 'white' }}>
                  🏥
                </div>
                ...
                <p className="mt-2 text-sm font-semibold" style={{ color: 'var(--budr-teal)' }}>Til personale</p>
                <p className="mt-3 text-sm leading-relaxed text-slate-600">
                ...
                <ul className="mt-5 flex flex-col gap-2.5">
                  {[
                    ...
                    'Dokumentation klar til §-indsatser',
                    'GDPR-kompatibel dansk løsning',
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-2.5 text-sm text-slate-700">
                      <div className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full" style={{ background: 'rgba(29,158,117,0.15)' }}>
          ...
          <div className="mx-auto max-w-4xl">
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div
                ...
                data-reveal
                style={{ background: 'linear-gradient(135deg, rgba(127,119,221,0.09) 0%, rgba(167,139,250,0.12) 100%)', border: '1.5px solid rgba(127,119,221,0.15)' }}
              >
                ...
                <p className="relative text-lg font-semibold leading-relaxed text-slate-800 sm:text-xl">
                  Borgerne fortæller os, hvad der sker — selv når de ikke har ord for det.
                  BUDR giver dem sproget og strukturen til at række ud.
                </p>
              ...
              <div
                ...
                style={{ background: 'linear-gradient(135deg, rgba(29,158,117,0.07) 0%, rgba(52,211,153,0.10) 100%)', border: '1.5px solid rgba(29,158,117,0.15)' }}
              >
                <span
                  className="pointer-events-none absolute -top-3 left-5 select-none text-8xl font-extrabold leading-none"
          ...
          <div className="mx-auto max-w-5xl">
            <div className="mb-12 text-center" data-reveal>
              <div
                ...
                style={{ borderColor: 'rgba(29,158,117,0.3)', background: 'rgba(29,158,117,0.08)', color: 'var(--budr-teal)' }}
              >
                🏥 Care Portal
              </div>
              <h2
            ...
            >
              {[
                ...
                {
                  icon: '📄',
                  title: '§-dokumentation på sekunder',
                  desc: 'BUDR genererer struktureret dokumentation klar til indberetning.',
                },
              ].map((card) => (
                <div
                  key={card.title}
        ...
        <section
          ...
          style={{ background: 'linear-gradient(135deg, var(--budr-navy) 0%, #1a1040 50%, #0d2a1f 100%)' }}
        >
          ...
          <div className="mx-auto max-w-6xl">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-slate-500">
                ...
                <a href="/privacy" className="hover:text-slate-800 transition-colors">Privatlivspolitik</a>
                <a href="/terms" className="hover:text-slate-800 transition-colors">Vilkår</a>
                <a href="https://www.linkedin.com/company/budr" target="_blank" rel="noopener noreferrer" className="hover:text-slate-800 transition-colors">
                  LinkedIn
                </a>
              </div>
            </div>
            <div className="mt-6 border-t pt-6 text-center text-xs text-slate-400" style={{ borderColor: 'rgba(0,0,0,0.06)' }}>
              © 2025 BUDR. Alle rettigheder forbeholdes.
            </div>
          </div>
        </footer>
