...
const MOCK_RESIDENTS: MockResident[] = [
  {
    ...
    initials: 'SK',
    room: '104',
    house: careDemoProfileById('res-sara')?.house ?? 'A',
    documents: [
      { category: 'journal', title: 'Natnotat — uro, tryghedsplan fulgt' },
      { category: 'handleplan', title: 'Recovery- og tryghedsplan' },
      { category: 'medicin', title: 'Olanzapin 5 mg morgen / 10 mg aften' },
      { category: 'medicin', title: 'Melatonin ved sengetid' },
      { category: 'aftaler', title: 'Statusmøde med kontaktpædagog' },
    ],
  },
  {
    id: 'res-mikkel',
    ...
    initials: 'MT',
    room: '103',
    house: careDemoProfileById('res-mikkel')?.house ?? 'A',
    documents: [
      { category: 'journal', title: 'Stabiliseringsplan — opfølgning' },
      { category: 'medicin', title: 'Abilify 10 mg' },
      { category: 'handleplan', title: 'Stabiliseringsplan' },
    ],
  },
  {
    id: 'res-anders',
    ...
    initials: 'AP',
    room: '109',
    house: careDemoProfileById('res-anders')?.house ?? 'A',
    documents: [
      { category: 'journal', title: 'Rolig fase — lithium niveau OK' },
      { category: 'medicin', title: 'Lithium 600 mg' },
      { category: 'aftaler', title: 'Lægevideo om to uger' },
    ],
  },
  {
    id: 'res-mette',
    ...
    initials: 'MP',
    room: '205',
    house: careDemoProfileById('res-mette')?.house ?? 'B',
    documents: [
      { category: 'journal', title: 'Deltog i morgenyoga' },
      { category: 'handleplan', title: 'Recovery og aktivitet' },
      { category: 'medicin', title: 'Sertralin 50 mg' },
    ],
  },
  {
    id: 'res-camilla',
    ...
    initials: 'CB',
    room: '211',
    house: careDemoProfileById('res-camilla')?.house ?? 'B',
    documents: [
      { category: 'journal', title: 'Rolig samtale efter misforståelse' },
      { category: 'handleplan', title: 'Relations- og tryghedsplan' },
      { category: 'medicin', title: 'Lamictal 100 mg' },
    ],
  },
  {
    id: 'res-jonas',
    ...
    initials: 'JF',
    room: '312',
    house: careDemoProfileById('res-jonas')?.house ?? 'C',
    documents: [
      { category: 'journal', title: 'Indflytningsplan — praktisk info' },
      { category: 'handleplan', title: 'Indflytningsplan' },
      { category: 'medicin', title: 'Risperidon 2 mg' },
      { category: 'aftaler', title: 'Opfølgning kontaktperson' },
    ],
  },
];
