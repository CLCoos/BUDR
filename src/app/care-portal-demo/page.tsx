...
export default function CarePortalDemoPage() {
  ...
  return (
    <div className="cp-demo-ambient flex h-screen flex-col overflow-hidden text-[15px] antialiased">
      <nav className="cp-glass-nav fixed left-0 right-0 top-0 z-50 flex h-[52px] items-center gap-3 px-4 sm:px-6">
        ...
        <p
          className="hidden min-w-0 flex-1 text-xs leading-snug lg:block"
          style={{ color: 'var(--cp-muted)' }}
        >
          Simuleret data — ikke jeres Supabase. Log ind for live drift og organisationsdata.
        </p>
      ...
      <main className="cp-scroll min-h-0 flex-1 overflow-y-auto pt-[52px]">
