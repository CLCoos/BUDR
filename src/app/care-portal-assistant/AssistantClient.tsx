...
const PRESET_ANSWERS: Record<string, string> = {
  'Hvem er beboerne her, og hvad er vigtigt at vide?': `Bostedet har aktuelt fem beboere. Generelt er det vigtigt at kende den enkeltes dagsrytme og trivselsmarkører — nogle har brug for struktur og forudsigelighed, andre trives bedst med lidt løsere rammer.
...
Hvis du er i tvivl om en beboer, er det altid bedre at spørge end at gætte.`,
  ...
  'Hvad gør jeg hvis en beboer nægter at tage sin medicin?': `Første skridt er at spørge roligt og nysgerrigt: "Er der noget særligt ved medicinen i dag?" — ofte er der en grund, fx bivirkninger, glemsel eller dårlig dag. Undgå at presse eller argumentere, da det typisk forværrer situationen.
...
Prøv evt. igen efter 30 minutter med en anden indgangsvinkel, eller tilbyd at tage medicinen på en anden måde, hvis det er muligt.`,
  ...
  'Hvordan håndterer jeg en konflikt mellem to beboere?': `Hold dig rolig og neutral — din ro smitter. Adskil de to beboere fysisk, gerne ved at bede den ene om at følge med dig et andet sted hen, uden at det føles som en straf. Undgå at tage parti.
...
Dokumentér hændelsen i journalen for begge beboere: hvad skete der, hvad var din reaktion, og hvad blev resultatet. Informér din leder ved næste møde, eller med det samme hvis situationen var alvorlig.`,
  ...
  'Hvad skal jeg skrive i journalen efter en hændelse?': `En god journalnotits er faktuel, konkret og uden fortolkning. Skriv hvad du observerede — ikke hvad du tror beboeren "mente" eller "følte". Brug gerne SOAP-strukturen: Situation, Observation, Analyse, Plan.
...
Husk: journalen er et juridisk dokument. Skriv altid med dit navn, og aldrig noget du ikke ville sige direkte til beboeren.`,
  ...
  'Hvornår må man anvende magt ifølge loven?': `Magtanvendelse over for voksne med betydelig og varigt nedsat psykisk funktionsevne reguleres af Servicelovens §§ 124–136. Udgangspunktet er klart: magt må kun bruges som absolut sidste udvej og aldrig som straf eller bekvemmelighed.
...
Som udgangspunkt: kald på en kollega, forsøg verbal de-eskalering, skab ro i rummet — og brug kun fysisk indgriben hvis beboeren er i overhængende fare for at skade sig selv eller andre. Ring til din leder eller vagttelefonen inden du handler, hvis situationen tillader det.`,
  ...
  'En beboer vil ikke forlade sit værelse. Hvad gør jeg?': `Respektér i første omgang beboerens ønske — det er hans eller hendes ret at opholde sig på værelset. Bank på, præsenter dig roligt, og spørg om du må komme ind eller tale ved døren. Undgå at kræve eller ultimere.
