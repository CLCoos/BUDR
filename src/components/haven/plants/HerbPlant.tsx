...
export default function HerbPlant({ stage, accent = '#10B981' }: Props) {
  ...
  if (stage === 0) return (
    <svg viewBox="0 0 80 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <line x1="40" y1="86" x2="40" y2="72" stroke={stem} strokeWidth="2.5" strokeLinecap="round" />
  ...
  if (stage === 3) return (
    <svg viewBox="0 0 80 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <line x1="40" y1="88" x2="40" y2="44" stroke={stem} strokeWidth="3.5" strokeLinecap="round" />
  ...
  return (
    <svg viewBox="0 0 80 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <ellipse cx="28" cy="85" rx="8" ry="5" fill={leaf} opacity="0.7" transform="rotate(-20 28 85)" />
      <ellipse cx="52" cy="85" rx="8" ry="5" fill={leaf} opacity="0.65" transform="rotate(20 52 85)" />
